    ...
    <Document>
      <Page style={styles.page}>
        ...
        <View style={styles.mainTitle}>
          <Text style={styles.title}>Testimonial</Text>
        </View>

        <View>
          <Text style={styles.para}>
            This is to certify that {user?.username}, Son of{" "}
            {user?.parentDetailsFather?.name} and{" "}
            {user?.parentDetailsMother?.name}, born on {formattedDate}, is
            currently enrolled in {user?.class} at Easy School. He exhibits
            commendable academic performance and displays exemplary behavior.
          </Text>
